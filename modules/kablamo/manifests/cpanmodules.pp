class kablamo::cpanmodules ($ensure='present') {
    ...
    cpanm { 'IO::Pty':                             ensure => $ensure } # VimDebug
    ...
    cpanm { 'Net::Telnet':                         ensure => $ensure } # VimDebug
    ...
    cpanm { 'POE':                                 ensure => $ensure } # VimDebug
    ...
    cpanm { 'Term::Spark':                         ensure => $ensure }
    cpanm { 'Term::Vspark':                        ensure => $ensure }
